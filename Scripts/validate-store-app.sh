...
prohibited_pattern='CGDisplay(Hide|Show)Cursor|CGCursorIsVisible|SetsCursorInBackground|_?CGS[A-Z_][A-Za-z0-9_]*|SLS[A-Z_][A-Za-z0-9_]*|KineticCursorModel|KineticResponse|kineticEnabled|kineticResponse|rotationRadians|CGContextRotateCTM|CGAffineTransformRotate|/System/Library/PrivateFrameworks/'
scanned_mach_o=0
